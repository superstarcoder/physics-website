...
export default function NavContentOld(props: {content: Object, path:string, position:number}) {
				...
				if (value.hasOwnProperty("children")) {
					ls.push(
						...
						<div className={styles.navFolder} id={key} key={key} style={{backgroundColor: `hsl(${238-(props.position*4)}, 100%, 64%)`}}>
							...
							<NavContentOld content={value["children"]} path={link} position={props.position+1}/>
						</div>
					)
				}
